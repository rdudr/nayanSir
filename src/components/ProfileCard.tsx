...
export default function ProfileCard() {
  return (
    <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-3xl p-6 sm:p-8 text-white shadow-2xl">
      {/* Professor Photo */}
      <div className="rounded-2xl h-72 sm:h-80 mb-6 overflow-hidden">
        <img
          src="/NARANSIR.jpg"
      ...
      {/* Name */}
      <h2 className="text-2xl font-bold text-center mb-3">Prof. Naran M. Pindoriya</h2>

      {/* Title & Department */}
      <div className="text-center space-y-1 mb-6">
        <p className="text-blue-100">Professor</p>
        <p className="text-blue-100">Department of Electrical Engineering</p>
        <p className="text-blue-100">IIT Gandhinagar</p>
      </div>
      ...
      <Link
        ...
        className="block"
      >
        <button className="w-full bg-teal-500 text-white font-medium py-3 rounded-xl hover:bg-teal-600 transition-colors">
          View Resume
        </button>
      </Link>
    </div>
